...
const schema = new mongoose.Schema(
{
  ...
  "CARATTERISTICHE COSTRUTTIVE": { type: String, required: true },
  "SCHERMATURE DI CAMPO MAGNETICO": { type: String, required: true },
...
{ collection: "Certificazione Gabbia", timestamps: false }
);

schema.index({ Cod: 1 }, { unique: true });

export default mongoose.model("CertificazioneGabbia", schema);
